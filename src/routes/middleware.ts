...
const createRateLimit = (
  options: Partial<IRateLimiterMongoOptions>,
  setHeaders = true
...
export const rateLimit = {
  ...
  "local-login-slow": createRateLimit({
    points: 200,
    duration: 60 * 60 * 24,
    keyPrefix: "local-login-slow",
  }), // 200 per 1 day
  ...
  "send-email-verify": createRateLimit({
    points: 50,
    duration: 60 * 60 * 6,
    keyPrefix: "send-email-verify",
  }), // 50 per 6 hours
  "forgot-code": createRateLimit({ points: 100, duration: 60 * 60 * 24, keyPrefix: "forgot-code" }), // 100 per 1 day
  "send-email-forgot": createRateLimit({
    points: 50,
    duration: 60 * 60 * 6,
    keyPrefix: "send-email-forgot",
  }), // 50 per 6 hours
  "local-change-password": createRateLimit({
    points: 20,
    duration: 60 * 60,
    keyPrefix: "local-change-password",
  }), // 20 per 60 min
  ...
  "oauth-authorize": createRateLimit({
    points: 200,
    duration: 60 * 30,
